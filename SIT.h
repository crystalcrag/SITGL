...
enum
{
	...
	SIT_TagPrivate1      = 26,
	SIT_TagPrivate2      = 27,
	SIT_BuddyLabel       = 28,   /* C___: String,SIT_Widget * */
	SIT_Composited       = 29,   /* CSG_: Int */
	SIT_NVGcontext       = 30,   /* __G_: NVGcontext * */
	SIT_ToolTip          = 31,   /* CS__: String */
	SIT_OuterRect        = 32,   /* __G_: Int[4] or Rect */
	...
	SIT_Margins          = 49,   /* CSGR: Int,Int,Int,Int (T,R,B,L) (unit) */
	SIT_MaxWidth         = 50,   /* CSGR: SIT_Widget */
	SIT_MinWidth         = 51,   /* CSGR: Int (unit) */
	SIT_MinHeight        = 52,   /* CSGR: Int (unit) */
	SIT_MaxBoxWidth      = 53,   /* CSGR: Int (unit) */
	SIT_MaxBoxHeight     = 54,   /* CSGR: Int (unit) */
	SIT_EndCommonTags    = 55,   /* Sentinel, not a tag */
