...
static int cssAttrHash(DATA8 str, int len)
{
	static uint8_t asso_values[] = {
		...
		206, 206, 206, 206, 206, 206, 206, 206, 206, 206,
		 30,   0,  35,  15,   0,   5,  45,  40,  60, 206,
		206,  70,  30,  60,   0,  20, 206,   5,  35,   0,
		206,   0,  30, 206,  90,   0, 206, 206, 206, 206,
		206, 206,  30,   0,  35,  15,   0,   5,  45,  40,
		 60, 206, 206,  70,  30,  60,   0,  20, 206,   5,
		 35,   0, 206,   0,  30, 206,  90,   0,
	};
	uint8_t chr;
	int     hval = len;

	#define decodeState(ref)    ((chr = ref) > 122 || chr < 45 ? 206 : asso_values[chr-45])
	switch (hval) {
...
CSSAttr cssAttrSearch(STRPTR str)
{
	static uint8_t wordlist[] = {
		255, 255, 255, 255, 255, 255, 255,  66,  75,  55, 255,  33, 255,  63,  51,  52,
		 27, 255,  62, 255, 255, 255,  31,  83, 255, 255,  79,  22, 255, 255,   8,  78,
		 72, 255, 255, 255,   3, 255,  68,  84,   9,  81,  45,  26, 255,  49,  56,  53,
		 80,  41,  24,  69,   7, 255,  42, 255,  54,  25,  11,  30, 255,   5, 255,  16,
		 21, 255, 255,  38, 255, 255,  47, 255,  73, 255,  57,  90,  89, 255, 255,  17,
		 77, 255,  12,  39,  43, 255, 255,  23,  10, 255, 255,  34, 255,  70,  71, 255,
		 60,  61,  29,  36,  15,  14,  32,  20,  74, 255,   4, 255, 255,  82,   2,  19,
		255,  64, 255, 255, 255, 255,  40, 255, 255,  59,  37,  13, 255, 255,  28,  48,
		255,   6,  76, 255, 255,  35,  18, 255, 255, 255, 255, 255, 255, 255, 255, 255,
		255, 255, 255,  91, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
		255,  87, 255, 255,  88, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
		 50, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,
		255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255,  58,  67,
    };
